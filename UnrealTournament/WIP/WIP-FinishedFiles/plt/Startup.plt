...
Video="Konfiguracja multimedialna Unreal Tournament"
; EN: Audio="Unreal Tournament Multimedia Configuration"
Audio="Konfiguracja multimedialna Unreal Tournament"
...
IDC_MouseInputPrompt="Wybierz metodę wprowadzania dla myszy.\n\nKursor — wejście myszy o niskiej rozdzielczości. Ten tryb ogranicza mysz do 400 DPI i stosuje akcelerację wskaźnika Windows do danych wejściowych.\n\nDirectInput — [Przestarzałe] Wejście myszy o wysokiej rozdzielczości. Ten tryb pozwala myszy zgłaszać ruch przy wyższym DPI i nie podlega akceleracji wskaźnika Windows. Ten tryb nie działa dobrze w nowoczesnych wersjach systemu Windows.\n\nSurowe wejście — wejście myszy o wysokiej rozdzielczości. Ten tryb pozwala myszy zgłaszać ruch przy wyższej rozdzielczości DPI i nie podlega akceleracji wskaźnika Windows. Jest to zalecany tryb dla nowoczesnego sprzętu i nowoczesnych wersji systemu Windows."
