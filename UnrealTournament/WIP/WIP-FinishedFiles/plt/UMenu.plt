...
DoUplinkHelp="Jeśli zaznaczone, będą widoczne ślady po pociskach i krwi podczas rozgrywki."
...
MinFramerateText="Min. szybkość klatek"
...
GoreLevels[1]="Obniżona"
; EN: GoreLevels[2]="Ultra-Low"
GoreLevels[2]="Ultra-niska"
...
PatchName="Pobierz najnowsze &aktualizacje"
...
SkillTaunts[0]="Nie skrzywdzą cię...za bardzo."
; EN: SkillTaunts[1]="Don't get cocky."
SkillTaunts[1]="Nie podskakuj."
...
AutoAdjustText="Auto regulacja umiejętn"
...
InvertMouseHelp="Odwróć oś Y myszy. Kiedy włączone, popchnięcie myszy do przodu powoduje, że patrzysz w dół, a nie w górę."
; EN: LookSpringText="Look Spring"
LookSpringText="Sprężynowy widok"
...
SensitivityHelp="Dostosuj czułość myszy, czyli jak daleko musisz przesunąć mysz, aby wykonać dany ruch w grze."
...
MouseSmoothHelp="Jeśli ta opcja jest zaznaczona, sygnał z myszy będzie wygładzany, aby poprawić płynność działania Patrzenie myszą."
...
SkillStrings[2]="Dla ludzi o mocnych nerwach."
...
ExcludeCaption="Mapy poza cyklem"
...
IncludeHelp="Kliknij i przeciągnij mapę do lewej kolumny, aby usunąć ją z listy cyklu map, lub przeciągnij ją w górę lub w dół, aby zmienić jej kolejność na liście cyklu map."
...
SlotHelp="Naciśnij, aby aktywować tą pozycję. (Zapisz/Załaduj)"
...
AboutHelp="Zobacz napisy o tym, kto stworzył Unreal Tournament."
