...
CrosshairSmoothText="Gładki celownik"
; EN: CrosshairSmoothHelp="Enable to apply smoothing to your crosshair."
CrosshairSmoothHelp="Włącz wygładzanie do twojego celownika."
...
CrosshairTranslucentHelp="Włącz stosowanie przezroczystości do twojego celownika."
...
ConfirmHardwareText="Sprzętowa funkcja dźwięku 3D wymaga posiadania karty dźwiękowej 3D obsługującej format A3D lub EAX. Włączenie tej opcji może również w niektórych przypadkach znacznie obniżyć wydajność. \ N \ nCzy na pewno chcesz włączyć tę funkcję?"
...
ConfirmSurroundText="Funkcja dźwięku przestrzennego wymaga posiadania kompatybilnego odbiornika dźwięku przestrzennego podłączonego do karty dźwiękowej. Włączenie tej opcji bez odpowiedniego odbiornika może spowodować anomalie w jakości dźwięku. \ N \ nCzy na pewno chcesz włączyć tę funkcję?"
