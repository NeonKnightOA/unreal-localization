...
Object=(Name=BotPack.TMale1Bot,Class=Class,MetaClass=BotPack.Bot,Description="Commando")
Object=(Name=BotPack.TMale1,Class=Class,MetaClass=Botpack.TournamentPlayer,Description="Commando")
Object=(Name=BotPack.TMale2Bot,Class=Class,MetaClass=BotPack.Bot,Description="Soldat")
Object=(Name=BotPack.TMale2,Class=Class,MetaClass=Botpack.TournamentPlayer,Description="Soldat")
Object=(Name=BotPack.TFemale1Bot,Class=Class,MetaClass=BotPack.Bot,Description="Femme Commando")
Object=(Name=BotPack.TFemale1,Class=Class,MetaClass=Botpack.TournamentPlayer,Description="Femme Commando")
Object=(Name=BotPack.TFemale2Bot,Class=Class,MetaClass=BotPack.Bot,Description="Femme Soldat")
Object=(Name=BotPack.TFemale2,Class=Class,MetaClass=Botpack.TournamentPlayer,Description="Femme Soldat")
...
Object=(Name=BotPack.UT_BioRifle,Class=Class,MetaClass=Botpack.TournamentWeapon,Description="Fusil Bio")
Object=(Name=BotPack.UT_Eightball,Class=Class,MetaClass=Botpack.TournamentWeapon,Description="Lance-roquettes")
Object=(Name=BotPack.UT_FlakCannon,Class=Class,MetaClass=Botpack.TournamentWeapon,Description="Canon DCA")
...
Object=(Name=BotPack.InstaGibDM,Class=Class,MetaClass=Engine.Mutator,Description="InstaGib DM")
Object=(Name=BotPack.PulseArena,Class=Class,MetaClass=Engine.Mutator,Description="Fusils à impulsion uniquement !")
Object=(Name=BotPack.FlakArena,Class=Class,MetaClass=Engine.Mutator,Description="Canons DCA uniquement !")
Object=(Name=BotPack.RocketArena,Class=Class,MetaClass=Engine.Mutator,Description="Lances-roquettes uniquement !")
Object=(Name=BotPack.ShockArena,Class=Class,MetaClass=Engine.Mutator,Description="Fusils de choc uniquement !")
Object=(Name=BotPack.SniperArena,Class=Class,MetaClass=Engine.Mutator,Description="Fusils de précision uniquement !")
Object=(Name=BotPack.ChainsawMelee,Class=Class,MetaClass=Engine.Mutator,Description="Match tronçonneuse")
Object=(Name=BotPack.NoRedeemer,Class=Class,MetaClass=Engine.Mutator,Description="Pas de rédempteur")
Object=(Name=BotPack.NoPowerups,Class=Class,MetaClass=Engine.Mutator,Description="Pas de bonus")
Object=(Name=BotPack.LowGrav,Class=Class,MetaClass=Engine.Mutator,Description="Faible gravité ")
Object=(Name=BotPack.Stealth,Class=Class,MetaClass=Engine.Mutator,Description="Furtif - Tout le monde est invisible")
Object=(Name=BotPack.FatBoy,Class=Class,MetaClass=Engine.Mutator,Description="Fatboy,Fatboy!")
Object=(Name=BotPack.JumpMatch,Class=Class,MetaClass=Engine.Mutator,Description="MatchSaut,Les joueurs seront capables de sauter très haut")
...
GameName=Tournoi Partie en équipe
...
SingleWaitingMessage=
GameName=Entraînement au combat : MAM
...
PickupMessage=Vous avez récupéré le fusil ASMD de choc.
...
PickupMessage=Vous avez récupéré le pistolet à impulsion
...
PickupMessage=Vous avez récupéré le canon DCA.
ItemName=Canon DCA

[UDamage]
PickupMessage=Vous avez récupéré l'amplificateur de dommages !
...
PickupMessage=Vous avez récupéré le FusilBio.
ItemName=FusilBio
...
TauntAbbrev[13]=Essaie sans la sécurité.
...
ItemName=Balles de grande taille

[ControlPointMessage]
ControlPointStr=Point de contrôle
ControlledBy=sous le contrôle de l' 
TeamStr= !
ClaimedStr=revendiqué !

[TFemale1]
MenuName=Femme Commando

[TFemale1Bot]
MenuName=Femme Commando

[BulletBox]
PickupMessage=Vous avez récupéré une boîte de cartouches de fusil.
...
[ShockCore]
PickupMessage=Vous avez récupéré un noyau de choc.
...
PickupMessage=Vous avez récupéré le fusil de choc amélioré.
ItemName=Fusil de choc amélioré

[bioammo]
PickupMessage=Vous avez récupéré des munitions Biosludge.
...
[flakammo]
PickupMessage=Vous avez récupéré 10 cartouches DCA.
ItemName=Cartouches DCA

[SuperShockCore]
PickupMessage=Vous avez récupéré un noyau de choc amélioré.
...
[HealthVial]
PickupMessage=Vous avez récupéré une ampoule de santé +
ItemName=Ampoule de santé
...
[ChallengeDMP]
GameName=Challenge - Match à mort

[RatedTeamInfoS]
TeamName=Colère de Dieu
TeamBio=L'équipe Colère de Dieu est l'actuelle favorite du Tournoi. Savante combinaison de puissance et de style, elle se débarrasse de ses adversaires avec classe.
...
TeamBio=Cet escadron de vétérans d'élite était autrefois attaché à la sécurité personnelle du trafiquant d'armes Jihan Nyhn. Après l'assassinat de Jihan, les gardes de fer se retrouvèrent sans emploi et le Tournoi leur parut une scène idéale pour démontrer leurs qualités de guerriers.
...
BotBio[0]=Harlin est un combattant solide et fort d'une longue expérience. Il a rejoint l'équipe des Gardes de fer après avoir assisté au massacre de sa famille par les Storm Troopers du NEG.
BotBio[1]=On ne sait presque rien sur Rylisa ou sur les motivations qui l'ont poussée à rejoindre les Gardes de fer. Presque tous les membres de la Garde ont une raison de combattre le NEG et la Liandri, mais elle n'a rien révélé à personne depuis son arrivée.
...
BotBio[3]=On dit que Lauren a été la maîtresse de Jihan Nyhn. Soupçonnant la Liandri d'être la cause de sa mort, elle a rejoint les rangs de la Garde de fer pour découvrir la vérité.
...
BotBio[5]=Shyann est experte en armes et en équipement. C'est la technicienne et l'armurière de la Garde de fer.
...
TeamBio=Groupe constitué de mercenaires et d'anciens spécialistes militaires, les Charognards recherchent la gloire et la fortune. Nul doute qu'ils feront tout pour remporter le prix du Tournoi : richesses et pouvoirs quasi illimités.
...
BotBio[2]=Contrairement à la plupart des Charognards, Mariana servit fidèlement le NEG pendant quatre ans à l'issue desquels elle fut remerciée sans beaucoup de ménagement. Elle estime que le gouvernement et la Liandri lui en doivent plus.
...
BotBio[6]=En compétition, Tanya est l'éclaireur des Charognards. Leur succès ne tient pas uniquement à leur expérience mais aussi aux renseignements qu'ils échangent.
BotBio[7]=Graves s'est enfui des forces de sécurité du NEG après avoir été suspendu  pour usage excessif de la force. Il met désormais sa force au service des objectifs des Charognards.

[RatedTeamInfo2]
TeamName=Légion noire
TeamBio=Puissante section d'assassins de Necris Phayder qui cherchent à dominer le Tournoi. En détruisant Xan Kriegor, le champion corrompu du Tournoi, la légion espère prendre le contrôle de la Liandri.
...
BotBio[2]=Vierge Necris du plus haut rang, Freylis est une guerrière habile et expérimentée. Parfaitement adaptée au travail en équipe, elle se trouve toujours là où son équipe a le plus besoin d'elle.
...
BotBio[5]=Necroth est le Maître Phayder de la Légion noire. Chaque Maître Necris agit comme une sorte de guide spirituel veillant au moral des troupes.
...
BotBio[7]=Grail est le membre le plus éduqué de la Légion. Il attend calmement son heure, pour prendre le contrôle des opérations.

[RatedTeamInfoDemo2]
TeamName=Colère de Dieu
TeamBio=L'équipe Colère de Dieu est l'actuelle favorite du Tournoi. Savante combinaison de puissance et de style, ils se débarrassent de leurs adversaires avec classe.
BotClassifications[0]=Guerrier
BotClassifications[1]=Guerrier
...
[RatedTeamInfo5]
TeamName=Venin
TeamBio=Venin est le nom d'une faction de guerrières et d'athlètes d'élite. Tous les membres de la faction sont des femmes qui se battent par pur plaisir.
BotClassifications[0]=Guerrier
BotClassifications[1]=Guerrier
BotClassifications[2]=Guerrier
BotClassifications[3]=Guerrier
...
[RatedTeamInfo4]
TeamName=Acier brut
TeamBio=L'unité Acier brut n'accepte que les hommes dans ses effectifs. Amas de muscle et de métal, les guerriers de l'unité Acier brut élèvent force et puissance au rang de vertus suprêmes.
BotClassifications[0]=Guerrier
BotClassifications[1]=Guerrier
BotClassifications[2]=Guerrier
BotClassifications[3]=Guerrier
...
BotClassifications[6]=Guerrier
BotClassifications[7]=Guerrier
BotBio[0]=Slain est le fondateur de l'équipe Acier brut. Il sait que leur succès ne tient pas uniquement à leur force physique, mais aussi à leur style de catcheurs made in USA qui plaît tant aux spectateurs.
BotBio[1]=Manwell est le représentant le plus puissant de l'équipe Acier brut. Il utilise un savant dosage de développements biochimiques pour maintenant sa puissance au niveau maximal en permanence.
BotBio[2]=Kregore est un sacré gaillard. Ayant survécu à d'innombrables Tournois, il connaît les arènes mieux que personne et possède une expérience unique au sein de l'équipe Acier brut.
...
BotBio[4]=Arkon a quitté les forces de sécurité du NEG lorsque l'équipe Acier brut lui proposa une place. N'ayant jamais beaucoup apprécié la discipline militaire, il trouve l'absence totale de règles qui prévaut dans le Tournoi tout à fait à son goût.
...
MapDescription[9]=Pour se renflouer après une opération hasardeuse de création de station de recherche sur la lune arctique de Coret, la Liandri Corp. a transformé cet avant-poste glacial en arène de Tournoi.
...
TeamBio=La phalange noire est une honorable société constituée de spécialistes militaires. Tous se sont distingués au cours de la guerre entre les humains et les Skaarjs, et tous cherchent aujourd'hui à retrouver le frisson du combat dans les arènes du Tournoi.
...
BotBio[0]=Ivana est une guerrière autodidacte qui a rejoint les Phalanges noires lorsqu'elle apprit que Gorn avait triomphé de l'impossible sur Neurovision un soir d'entraînement. Elle en fut tant émue qu'elle décida se rejoindre l'équipe et de se battre aux côtés de Gorn.
...
BotBio[2]=Nikita est formée à la construction et à la maintenance d'armes lourdes et d'engins de destruction. Elle gère l'armurerie de la Phalange.
...
Bio[4]=Loque est soupçonné d'appartenir aux Phayders. Il a été capturé alors qu'il rôdait autour des bâtiments du directoire de Io. Les Phayders ont récemment redoublé d'activité et sont suspectés d'être responsables d'au moins 6 attentats à la bombe nucléaire contre les installations du NEG au cours des derniers mois.
Bio[5]=Azure a passé six longues années sur Mars pour des raisons encore classées secret-défense. Elle a été récemment mutée dans le Tournoi, mais c'est tout ce que l'on sait sur elle.
...
Bio[0]=Orphelin à la naissance, ce tueur sans coeur a passé des années dans la rue, perdant toute capacité à s'émouvoir à mesure qu'il apprenait à défendre sa peau. Les Corrompus n'ont pas eu grand mal à tirer profit de ses compétences. Désormais totalement dépourvu de sentiments humains, Damascus est une machine impitoyable.
Bio[1]=En matière de lutte contre le dopage, la politique de la Liandri se résume à cette méthode : ne dis rien, on ne te demandera rien. Darhl est un grand consommateur de produits dopants. Sa technique est assez imprévisible, troquant régulièrement ses armes de longue portée contre le Marteau de combat rapproché.
...
Bio[1]=De nombreux guerriers Necris sont des femmes. Connues sous le nom de 'Vierges', elles se battent avec férocité avec leurs armes de prédilection : baïonnettes et épées à énergie. Visse est une prisonnière de guerre Necris qui combat dans le Tournoi en échange de la vie sauve.
...
Bio[0]=Esclave guerrier. Membre des 'Corrompus', un groupe de guerriers reprogrammés qui se battent pour la distraction de Xan Kriegor.
Bio[1]=Esclave guerrier. Membre des 'Corrompus', un groupe de guerriers reprogrammés qui se battent pour la distraction de Xan Kriegor.
Bio[2]=Esclave guerrier. Membre des 'Corrompus', un groupe de guerriers reprogrammés qui se battent pour la distraction de Xan Kriegor.
Bio[3]=Esclave guerrier. Membre des 'Corrompus', un groupe de guerriers reprogrammés qui se battent pour la distraction de Xan Kriegor.
Bio[4]=Esclave guerrier. Membre des 'Corrompus', un groupe de guerriers reprogrammés qui se battent pour la distraction de Xan Kriegor.
...
MapTitle[2]=Fonderie
MapTitle[3]=Condamné
MapTitle[4]=Ancien réservoir d'eau
MapTitle[5]=Rêve de métal
MapDescription[0]=Apprenez les règles et les systèmes de base du mode Domination dans ce centre d'entraînement spécial. Testez votre habileté contre un groupe d'adversaires non entraînés avant de participer au Tournoi.
MapDescription[1]=En dépit des protestations internationales, ce lieu historique est aujourd'hui la propriété de la Liandri. 'Ce lieu d'histoire a été cédé au mieux disant culturel. Il est de notre devoir de ne pas dévier de la voie de la qualité', déclara Jerl Liandri, PDG de la Liandri Mining Corporation, lors de son discours d'inauguration.
MapDescription[2]=Après des dizaines d'accidents du travail et de regrettables incinérations, la Fonderie finit par être fermée, mise aux enchères et promptement ravie par un éclaireur au nez creux de la Liandri.
MapDescription[3]=Les guerres des gangs ont ravagé ce bloc d'immeubles. Les investisseurs de la Liandri, espérant capitaliser sur cette violence, ont acquis le quartier pour en faire une arène du Tournoi.
MapDescription[4]=Cet ancien temple était un lieu saint pour ceux qui l'édifièrent, mais pas pour la Liandri qui le transforma en arène de bataille dès sa découverte dans les montagnes au-dessus des Grottes éternelles.
MapDescription[5]=Cette plate-forme pétrolière souterraine a été convertie en arène de domination. Elle est située près d'un lieu où se manifestent d'étranges phénomènes météorologiques au nord de l'Alaska, a été convertie en arène de domination. Utilisez l'architecture pour dominer vos adversaires.

[LadderDMDemo]
MapTitle[0]=Didacticiel MAM
MapTitle[1]=Station polaire Zeto
MapTitle[2]=Monastère du Pic
MapTitle[3]=Cathédrale gothique
MapTitle[4]=Phobos
MapTitle[5]=Galion Koos
MapTitle[6]=Convoyeur
MapDescription[0]=Apprenez les règles et les systèmes de base du mode Match à mort dans ce centre d'entraînement spécial. Testez votre habileté contre un groupe d'adversaires non entraînés avant de participer au Tournoi.
MapDescription[1]=Pour se renflouer après une opération hasardeuse de création de station de recherche sur la lune arctique de Coret, la Liandri Corp. a transformé cet avant-poste glacial en arène de Tournoi.
MapDescription[2]=Construit à l'origine par les moines Nipi au Népal pour se protéger de la déchéance morale, cet endroit magnifique et serein devait inspirer la méditation. Ce fut le cas jusqu'à ce que la Liandri la trouve à son goût.
MapDescription[3]=...
MapDescription[4]=La position de cette station spatiale, entre Mars et sa lune Phobos, explique sa rotation chaotique. Fort heureusement, les générateurs de gravité fonctionnent suffisamment pour garantir un rythme soutenu aux matches à mort qui s'y déroulent.
MapDescription[5]=Les peuples indigènes de Koos vivent en milieu aquatique et ne connaissent pas d'arène mieux adaptée que cet ancien galion.
MapDescription[6]=Cette raffinerie constitue une arène particulièrement équilibrée. Dans la chambre centrale à plusieurs niveaux, les combattants grillent à petit feu près du bain de fusion.
