...
ID_NotifyExit="Wyłącz &wyłącz UnrealServer"
...
PropNone="Nic nie zostało zaznaczone"
...
InsertCdText="Włóż dysk CD-ROM Unreal Tournament do napędu i naciśnij OK, aby kontynuować, lub Anuluj, aby wyjść."
...
LowMemory="Unreal Tournament wykrył, że masz %i megabajtów dostępnej pamięci. Aby poprawić wydajność, włączono opcje „Tekstury o niskiej szczegółowości” i „Niska jakość dźwięku”. Możesz zmienić te ustawienia w menu „Ustawienia wydajności”."
...
NonMMX="Unreal Tournament wykrył, że używasz komputera PC innego niż MMX. Na tej podstawie szybkość odtwarzania dźwięku została ustawiona tak, aby zużywała najmniejszą moc procesora. Możesz zmienić te ustawienia w menu „Opcje zaawansowane/Dźwięk”."
...
Starting="Unreal Tournament uruchamia się po raz pierwszy. Jeśli napotkasz jakiekolwiek problemy, przeczytaj sekcję Rozwiązywanie problemów w Uwagach do wydania w folderze „Pomoc”."
