...
MissingProduct="%ls nécessite que %ls soit d'abord installé dans le dossier. Veuillez localiser le dossier existant pour %ls, ou quitter et installer maintenant.\n\nVous pouvez cliquer sur le lien Web ci-dessous pour obtenir des informations sur le produit."
...
AdviseBadDest="Le lecteur de destination est peut-être plein ou comporte des secteurs défectueux."
...
CancelPrompt="Attention! Annuler l'installation maintenant empêchera %ls de fonctionner correctement. Êtes-vous sûr de vouloir l'annuler?"
...
IDC_InstallingText="En traitement:"
; EN: IDC_ProgressText="File Progress:"
IDC_ProgressText="Progression du fichier:"
; EN: IDC_TotalText="Total Progress:"
IDC_TotalText="Progrès total:"
...
IDC_RestartText="Avant de redémarrer, fermez toutes les applications ouvertes et enregistrez tous les documents ouverts actuels; retirez tous les disques et unités externes insérés, puis cliquez sur le bouton «Redémarrer le système»."
...
IDC_Options="Options de Unreal Tournament"
; EN: IDC_Play="&Play"
IDC_Play="&Jouer"
...
IDC_WizardDialog="Configuration de Unreal Tournament"
