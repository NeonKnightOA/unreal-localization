...
Preferences=(Caption="Prise en charge de Cluster 3D Audio",Parent="l'audio",Class=Cluster.ClusterAudioSubsystem,Immediate=True)
...
ClassCaption="Prise en charge de Cluster 3D Audio"
