...
HelpMessage[2]="Si c'est vrai, réduit le sang dans le jeu."
...
MenuList[0]="A Digital Extremes/Megagames épiques"
...
HelpMessage[5]="Ajustez la compétence globale de ce bot de ce montant (par rapport à la compétence de base pour les robots)."
...
HelpMessage[11]="S'il est activé, vous entendrez un bip lorsque vous recevez un message."
...
HelpMessage[15]="Si activé, la décoration projette des ombres. Les modifications apportées à ce paramètre prendront effet lors du changement de niveau suivant."
; EN: HelpMessage[16]="If blob, use blob shadows, else use realistic shadows with different resolutions."
HelpMessage[16]="Si blob, utilisez des ombres blob, sinon utilisez des ombres réalistes avec différentes résolutions."
...
HelpMessage[2]="Choisissez Carte."
...
HelpMessage[7]="Si elle est activée, la souris est toujours utilisée pour regarder de haut en bas, sans avoir besoin d'une touche de souris."
...
HelpMessage[14]="Appuyez sur Entrée pour prioriser l'ordre de changement d'arme. (Si jamais l'auto-switch est faux)"
...
HelpMessage[17]="Ajustez la quantité de balancement lors du déplacement."
...
MenuList[1]="Objectif automatique"
...
HelpMessage[1]="Si activé, les bots ajustent leur niveau de compétence en fonction de leurs performances face aux joueurs."
...
HelpMessage[5]="Nombre de robots pour commencer à jouer (max 15)."
...
HelpMessage[5]="DeathMatch contre les Bots."
...
HelpMessage[4]="Délai (en minutes) pour terminer la partie. Si 0, il n'y a pas de limite."
...
HelpMessage[6]="Si l'option Weapons Stay est activée, les armes réapparaissent instantanément, mais ne peuvent être récupérées qu'une seule fois par un joueur donné."
...
HelpMessage[3]="Pas pour les faibles de cœur."
...
ItemName="Powerup du pistolet de dispersion"
...
HelpMessage[10]="Pourcentage de dégâts subis par un tir ami. Notez que vous subissez toujours tous les dégâts de vos propres armes."
...
MenuList[6]="Réapparition instantanée des armes"
...
PickupMessage="Vous avez récupéré le Super Pack Santé"
