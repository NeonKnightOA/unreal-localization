...
Preferences=(Caption="Prise en charge audio FMOD 3D",Parent="l'audio",Class=FMODAudioDrv.FMODAudioDevice,Immediate=True)

[FMODAudioDevice]
; EN: ClassCaption="FMOD 3D Audio Support"
ClassCaption="Prise en charge audio FMOD 3D"
