...
Preferences=(Caption="Obsługa wideo XOpenG",Parent="Wykonanie",Class=XOpenGLDrv.XOpenGLRenderDevice,Immediate=True, Category="Options")
...
Preferences=(Caption="Opcje debugowania",Parent="Obsługa wideo XOpenGL",Class=XOpenGLDrv.XOpenGLRenderDevice,Immediate=True, Category="DebugOptions")
...
Preferences=(Caption="Opcje renderowania",Parent="Obsługa wideo XOpenGL",Class=XOpenGLDrv.XOpenGLRenderDevice,Immediate=True, Category="Client")
...
ClassCaption="Obsługa wideo XOpenGL"
