...
DLLVerString="%ls (wersja %i)"
; EN: WebURLString="Website URL"
WebURLString="Adres URL witryny"
; EN: ServerOSString="Server OS"
ServerOSString="System operacyjny serwera"
...
NewsName="Wiadomości społeczności"
; EN: RecentName="Recent servers"
RecentName="Najnowsze serwery"
...
RefreshServerName="&Pinguj ten serwer"
...
OpenHelp="Wprowadź standardowy adres URL lub wybierz go z historii adresów URL. Naciśnij klawisz Enter, aby aktywować."

[UBrowserServerWebWin]
; EN: WindowTitle="Web Explorer"
WindowTitle="Eksplorator sieci Web"

[UBrowserLibPageWindow]
; EN: DLLTitleStr="Can't connect: Missing Dynamic Link Library "%ls"."
DLLTitleStr="Nie można się połączyć: brak biblioteki linków dynamicznych „%ls”."
; EN: DLLVerTitleStr="Can't connect: Dynamic Link Library version mismatched "%ls"."
DLLVerTitleStr="Nie można się połączyć: niezgodna wersja biblioteki linków dynamicznych „%ls”."
; EN: InfoText[0]="To connect this server you will need additional C++ library "%ls"."
InfoText[0]="Aby połączyć się z tym serwerem, będziesz potrzebować dodatkowej biblioteki C ++ „%ls”."
; EN: InfoText[1]="For more info view the external info from below (hosted by %ls):"
InfoText[1]="Aby uzyskać więcej informacji, wyświetl poniższe informacje zewnętrzne (hostowane przez %ls):"
