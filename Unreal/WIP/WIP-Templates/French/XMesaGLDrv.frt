...
Preferences=(Caption="Mesa 3D",Parent="Le rendu",Class=XMesaGLDrv.XMesaGLRenderDevice,Immediate=True)
...
[XMesaGLRenderDevice]
ClassCaption="Mesa 3D"
; EN: AskInstalled="Do you have an OpenGL compatible 3D accelerator installed?"
AskInstalled="Avez-vous installé un accélérateur 3D compatible OpenGL?"
