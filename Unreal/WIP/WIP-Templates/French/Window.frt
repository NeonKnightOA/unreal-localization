...
LowMemory="Unreal a détecté que vous disposez de %i mégaoctets de mémoire. Pour améliorer les performances, les options "Low Detail Textures" et "Low Sound Quality" ont été activées. Vous pouvez modifier ces paramètres dans le menu "Paramètres de performances"."
...
NonMMX="Unreal a détecté que vous utilisez un PC non MMX. Sur cette base, la vitesse de lecture du son a été réglée pour utiliser le moins de puissance du processeur. Vous pouvez modifier ces paramètres dans le menu "Options avancées / Audio"."
...
Starting="Unreal démarre pour la première fois. Si vous rencontrez des problèmes, veuillez lire la section Dépannage des Notes de publication dans le dossier «Aide»."
