...
ExportWrite="Erreur lors de l'exportation de% ls: impossible d'écrire le fichier "% ls"."
...
ReadFileFailed="Échec de la lecture du fichier «% ls» pour l'importation."
...
NoTXTFile="Impossible d'exécuter le type de fichier non texte (.txt) "% ls"."
...
Copyright="Droits d'auteur 1999 Epic Games, Inc."
; EN: True="True"
True="Vrai"
; EN: False="False"
False="Faux"
