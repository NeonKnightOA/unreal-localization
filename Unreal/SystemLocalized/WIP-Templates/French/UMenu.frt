...
SuggestPlayerSetupText="Votre nom est actuellement défini sur "Joueur". Il est recommandé d'accéder à la configuration du lecteur et de vous donner un autre nom avant de jouer à une partie multijoueur. \ N \ nVoulez-vous plutôt accéder à la configuration du lecteur?"
...
SuggestNetspeedText="Vous n'avez pas encore configuré le type de connexion Internet avec lequel vous allez jouer. Il est recommandé d’accéder à l’écran Paramètres réseau pour vous assurer de bénéficier de la meilleure expérience de jeu en ligne. \ N \ nVoulez-vous plutôt accéder aux paramètres réseau?"
