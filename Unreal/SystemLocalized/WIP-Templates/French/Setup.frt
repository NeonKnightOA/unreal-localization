...
MissingProduct="%ls nécessite que %ls soit d'abord installé dans le dossier. Veuillez localiser le dossier existant pour %ls, ou quittez et installez-le maintenant.\n\nVous pouvez cliquer sur le lien Web ci-dessous pour obtenir des informations sur le produit."
...
OldVersion="%ls nécessite %ls version %i ou ultérieure, mais la version sur votre ordinateur est plus ancienne (vous avez la version %i). Veuillez installer %ls version %i ou ultérieure et réessayer. Vous pouvez cliquer sur le lien Web ci-dessous pour plus d'informations.\n\nLa configuration va maintenant se terminer."
...
WrongCd="La version attendue du fichier %ls %ls n’a pas été trouvée sur le lecteur de CD-ROM.\n\nVeuillez vérifier que le CD approprié se trouve dans le lecteur."
...
PatchCorrupt="Le fichier de correctif %ls est corrompu.\n\n %ls"
...
CdDescription="Pour installer la mise à jour %ls, certains fichiers doivent être copiés du CD-ROM d'origine %ls.\n\nVeuillez placer le CD-ROM %ls dans votre lecteur et cliquez sur "Suivant". Si la lettre de votre lecteur de CD n'est pas affichée correctement, veuillez la saisir ci-dessous."
...
IDC_WelcomePrompt="Vous êtes sur le point d'installer %ls sur votre ordinateur.\n\nCliquez sur "Suivant" pour commencer l'installation, ou cliquez sur "Annuler" à tout moment pour quitter.\n\nLes informations dans la zone ci-dessous contiennent des liens Web sur lesquels vous pouvez cliquer pour obtenir plus d'informations."
; EN: IDC_WelcomePromptUpdate="This program will update your copy of %ls to version %ls.\n\nClick "Next" to begin Setup, or click "Cancel" at any time to exit.\n\nThe information in the box below contains Web links you can click on to obtain more information."
IDC_WelcomePromptUpdate="Ce programme mettra à jour votre copie de %ls vers la version %ls.\n\nCliquez sur "Suivant" pour commencer l'installation, ou cliquez sur "Annuler" à tout moment pour quitter.\n\nLes informations dans la zone ci-dessous contiennent des liens Web que vous pouvez cliquez sur pour obtenir plus d'informations."
...
IDC_FolderDescription="Le programme d'installation installera %ls dans le dossier suivant.\n\nPour installer dans ce dossier, cliquez sur "Suivant".\n\nPour installer dans un autre dossier, saisissez le nom complet du nouveau dossier, y compris la lettre du lecteur, par exemple: "C:\newFolder"."
...
IDC_FolderDescriptionPatch="Le programme d'installation mettra à jour l'installation existante de %ls dans le dossier suivant.\n\nPour continuer, cliquez sur "Suivant".\n\nSi plusieurs copies sont installées, saisissez le nom complet du dossier existant, y compris la lettre du lecteur, par exemple: "C:\SomeFolder"."
...
IDC_FolderDescriptionMissing="Le programme d'installation mettra à jour une installation existante de %ls.\n\nTapez le nom complet du dossier existant, y compris la lettre du lecteur, par exemple: "C:\SomeFolder"."
...
IDC_FailedMessage="Ce produit nécessite que le produit suivant soit d'abord installé dans le dossier. Veuillez localiser le dossier existant ou quittez et installez-le maintenant.\n\nVous pouvez cliquer sur le lien Web ci-dessous pour plus d'informations."
...
IDC_WizardDialog="Configuration de Unreal"
