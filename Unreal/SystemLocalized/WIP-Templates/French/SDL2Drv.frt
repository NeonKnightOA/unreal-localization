...
Preferences=(Caption="SDL2",Parent="Affichage",Class=SDL2Drv.SDL2Client,Immediate=True,Category=Display)
; EN: Preferences=(Caption="SDL2",Parent="Joystick",Class=SDL2Drv.SDL2Client,Immediate=True,Category=Joystick)
Preferences=(Caption="SDL2",Parent="Manette",Class=SDL2Drv.SDL2Client,Immediate=True,Category=Joystick)
...
ClassCaption="Gestionnaire Linux SDL2 standard"
