...
Preferences=(Caption="UBrowser",Parent="La mise en réseau",Class=UBrowser.UBrowserMainClientWindow,Immediate=True)
...
TimeOutError="Expiration du délai de conversation avec le serveur maître"
...
NewsName="Nouvelles de la communauté"
; EN: RecentName="Recent servers"
RecentName="Serveurs récents"
...
ServerWebsiteName="Afficher le serveur et le site Web"
; EN: CopyAddressName="&Copy server address"
CopyAddressName="&amp; Copier l'adresse du serveur"
...
ClassCaption="Console du navigateur Unreal"
...
WindowTitle="Explorateur Web"

[UBrowserLibPageWindow]
; EN: DLLTitleStr="Can't connect: Missing Dynamic Link Library "%ls"."
DLLTitleStr="Connexion impossible: bibliothèque de liens dynamiques "% ls" manquante."
; EN: DLLVerTitleStr="Can't connect: Dynamic Link Library version mismatched "%ls"."
DLLVerTitleStr="Connexion impossible: la version de la bibliothèque de liens dynamiques ne correspond pas à "% ls"."
; EN: InfoText[0]="To connect this server you will need additional C++ library "%ls"."
InfoText[0]="Pour connecter ce serveur, vous aurez besoin d'une bibliothèque C ++ supplémentaire "% ls"."
; EN: InfoText[1]="For more info view the external info from below (hosted by %ls):"
InfoText[1]="Pour plus d'informations, consultez les informations externes ci-dessous (hébergées par% ls):"
