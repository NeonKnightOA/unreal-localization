...
IDC_DriverInfo="Puisque vous avez choisi OpenGL ou Direct3D, Unreal tentera d'utiliser cette carte vidéo.\n\nCependant, certains pilotes de carte 3D doivent être mis à jour afin de fonctionner de manière fiable avec les fonctionnalités 3D d'Unreal. Nous vous recommandons de suivre le lien Web ci-dessous pour plus d'informations sur la compatibilité de votre carte vidéo et pour obtenir les derniers pilotes Direct3D.\n\nSi vous rencontrez des problèmes graphiques tels que des couleurs incorrectes, des polygones clignotants, des performances lentes ou des plantages, veuillez utiliser le "Unreal Safe Mode" pour changer votre pilote vidéo."
