...
MissingProduct="% ls wymaga najpierw zainstalowania% ls w folderze. Zlokalizuj istniejący folder dla% ls lub zamknij go i zainstaluj teraz. \ N \ nMożesz kliknąć poniższe łącze internetowe, aby uzyskać informacje o produkcie."
...
OldVersion="% ls wymaga% ls w wersji% i lub nowszej, ale wersja na twoim komputerze jest starsza (masz wersję% i). Zainstaluj% ls wersję% i lub nowszą i spróbuj ponownie. Możesz kliknąć poniższe łącze internetowe, aby uzyskać więcej informacji. \ N \ nKonfiguracja zostanie teraz zamknięta."
...
WrongCd="Oczekiwana wersja pliku% ls% ls nie została znaleziona na dysku CD-ROM. \ N \ nSprawdź, czy w napędzie znajduje się właściwy dysk CD."
...
PatchCorrupt="Plik poprawki% ls jest uszkodzony. \ N \ n% ls"
...
Ready="Instalator jest gotowy do zainstalowania% ls. \ NFolder docelowy to:% ls \ n \ nKliknij „Instaluj”, aby rozpocząć instalację. \ NKliknij „Anuluj”, aby zakończyć bez instalowania% ls."
...
CancelPrompt="Ostrzeżenie! Anulowanie instalacji teraz uniemożliwi poprawne działanie% ls. Czy na pewno chcesz to anulować?"
...
CdDescription="Aby zainstalować aktualizację% ls, niektóre pliki muszą zostać skopiowane z oryginalnego dysku CD-ROM% ls. \ N \ nWłóż dysk CD% ls do napędu i kliknij "Dalej". Jeśli litera napędu CD jest wyświetlana nieprawidłowo, wprowadź ją poniżej."
...
IDC_WelcomePrompt="Zamierzasz zainstalować% ls na swoim komputerze. \ N \ nKliknij „Dalej”, aby rozpocząć instalację, lub kliknij „Anuluj” w dowolnym momencie, aby zakończyć. \ N \ nInformacje w poniższym polu zawierają łącza internetowe, które można kliknąć, aby uzyskać więcej informacji."
; EN: IDC_WelcomePromptUpdate="This program will update your copy of %ls to version %ls.\n\nClick "Next" to begin Setup, or click "Cancel" at any time to exit.\n\nThe information in the box below contains Web links you can click on to obtain more information."
IDC_WelcomePromptUpdate="Ten program zaktualizuje Twoją kopię% ls do wersji% ls. \ N \ nKliknij „Dalej”, aby rozpocząć instalację, lub kliknij „Anuluj” w dowolnym momencie, aby zakończyć. \ N \ nInformacje w polu poniżej zawierają łącza internetowe, które można kliknij, aby uzyskać więcej informacji."
...
IDC_LicenseQuestion="Czy zgadzasz się z powyższymi warunkami licencyjnymi? Kliknij „Zgadzam się”, jeśli tak, lub „Anuluj”, jeśli nie."
...
IDC_FolderDescription="Instalator zainstaluje% ls w następującym folderze. \ N \ nAby zainstalować w tym folderze, kliknij „Dalej”. \ N \ nAby zainstalować w innym folderze, wpisz pełną nazwę nowego folderu, łącznie z literą dysku, na przykład: „C: \ NewFolder”."
...
IDC_FolderDescriptionPatch="Instalator zaktualizuje istniejącą instalację% ls w następującym folderze. \ N \ nAby kontynuować, kliknij „Dalej”. \ N \ nJeśli masz zainstalowaną więcej niż jedną kopię, wpisz pełną nazwę istniejącego folderu, w tym literę dysku, na przykład: „C: \ SomeFolder”."
...
IDC_FolderDescriptionMissing="Instalator zaktualizuje istniejącą instalację% ls. \ N \ nWpisz pełną nazwę istniejącego folderu, w tym literę dysku, na przykład: „C: \ SomeFolder”."
...
IDC_FailedMessage="Ten produkt wymaga najpierw zainstalowania w folderze następującego produktu. Zlokalizuj istniejący folder lub zamknij go i zainstaluj teraz. \ N \ nMożesz kliknąć poniższe łącze internetowe, aby uzyskać więcej informacji."
...
IDC_Web="OldUnreal i witryna sieci Web"
...
IDC_CompleteReboot="Instalacja zakończona pomyślnie! \ NPrzed rozpoczęciem gry musisz ponownie uruchomić komputer."
