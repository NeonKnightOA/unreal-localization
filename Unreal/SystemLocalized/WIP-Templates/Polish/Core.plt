...
OldVersion="Plik „% ls” został zapisany w poprzedniej wersji, która nie jest wstecznie kompatybilna z tą. Czytanie go prawdopodobnie zakończy się niepowodzeniem i może spowodować awarię. Czy mimo to chcesz spróbować?"
; EN: Name="Name:"
Name="Nazwa:"
...
ReadFileFailed="Nie udało się odczytać pliku „% ls” do zaimportowania."
...
Assert="Twierdzenie nie powiodło się:% ls [plik:% ls] [wiersz:% i]."
