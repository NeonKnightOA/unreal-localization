...
Preferences=(Caption="Wsparcie S3 MeTaL",Parent="Wykonanie",Class=MeTaLDrv.MeTaLRenderDevice,Immediate=True)
...
AskUse="Czy chcesz, aby Unreal używał Twojej karty Savage 3D?"
