...
Message="Zastąpienie barierek magazynowych na poddaszu magazynu górnego."

[TranslatorEvent13]
; EN: AltMessage="Warehouse Safety Bars Disengaged: Access to Dock Permitted."
AltMessage="Odłączone kraty bezpieczeństwa w magazynie: dostęp do doku dozwolony."
...
Message="STATUS 4 POKŁADU ISV-KRAN: OSTRZEŻENIE O WŁAMANIU: AKTYWNE ZAMKI ZABEZPIECZAJĄCE: WEJŚCIA NA WSZYSTKIE POKŁADY I PRÓBA REAKTYWACJI SILNIKÓW GŁÓWNYCH - TELEPORTER AWARYJNY POKŁADU 1 NA MOSTKU ZABEZPIECZONY"

[TranslatorEvent1]
; EN: Message="Ventilation Processing Mezzanine Ducts: Maintenance Personnel Only: WARNING - ENGINE COOLANT LEAK IN MEZZANINE"
Message="Wentylacja Przewody mezzanine: Tylko personel konserwacyjny: OSTRZEŻENIE - WYCIEK PŁYNU CHŁODZĄCEGO SILNIKA NA MEZZANINIE"

[TranslatorEvent15]
; EN: Message="PANEL REWIRED TO TRIP ALARM - SYSTEM ACCESSED BY UNAUTHORIZED USERS"
Message="PANEL PRZYWRÓCONY DO ALARMU WYŁĄCZENIA - SYSTEM DOSTĘPNY PRZEZ NIEAUTORYZOWANYCH UŻYTKOWNIKÓW"

[TranslatorEvent2]
; EN: Message="Intruder Security Locks Activated - Bypass Required: Bypass panel located in Ventilation Processing Mezzanine."
Message="Aktywowane blokady bezpieczeństwa antywłamaniowego - wymagane obejście: panel obejścia znajdujący się na antresoli przetwarzania wentylacji."
; EN: AltMessage="Intruder Security Locks Disengaged"
AltMessage="Zwolnione blokady zabezpieczające przed włamaniem"
...
Message="STACJA ZAŁADUNKOWA ZAŁADUNKU: ISV-KRAN: Jesteśmy wciśnięci w ten grzbiet od 2 miesięcy. Każdej nocy te czteropiętrowe bestie typu dinozaurów przychodzą i biją w tylny kadłub statku. Wydają się być stosunkowo nieinteligentni i wolno się poruszają."

[TranslatorEvent33]
; EN: Message="SECURITY BYPASS LOCK STATION: SECURITY LOCKS ENGAGED"
Message="BLOKADA BEZPIECZEŃSTWA BYPASS: ZAMKNIĘTE ZAMKI BEZPIECZEŃSTWA"
; EN: AltMessage="SECURITY LOCK BYPASS STATION: ALL LOCKS OPEN ACCESS PERMITTED TO WAREHOUSE"
AltMessage="STACJA OBEJŚCIOWA Z BLOKADĄ BEZPIECZEŃSTWA: WSZYSTKIE ZAMKI OTWARTE DOSTĘP DO MAGAZYNU"
; EN: Hint="Touch this panel to open the security lock door."
Hint="Dotknij tego panelu, aby otworzyć drzwi blokady bezpieczeństwa."
...
Message="Kapral Anders Kerig: Nadchodzą! Słyszę je w kanałach wentylacyjnych. Zamierzam aktywować zamki bezpieczeństwa w Magazynie i wszczepić kod ludzkiego DNA, aby tylko inny Terran mógł ominąć systemy zamków."
...
Message="Kapral Pelli Onsov: Jeśli czytasz mój wpis w dzienniku, prawdopodobnie nie żyję, a nasz statek został opanowany przez kosmitów zwanych „Skaarj”. Twoją jedyną nadzieją jest zniszczenie złotych rdzeni zabezpieczających, ponowne aktywowanie silników i dotarcie do transporterów na pokładzie 1."
...
Message="Podoficer: Yuri Andromov: Grupa Wojny Obcych wybiła dziurę w kadłubie i dostają się do statku przez szyby wentylacyjne - Kerig, Onsov i ja mamy zamiar stanąć z Stingerami w strefie załadunku."
