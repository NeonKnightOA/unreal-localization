...
Message="Kontrola przepływu bioodpadów: przepływ bioodpadów jest stały. Monitoruj go pod kątem niebezpiecznych wahań lepkości lub ciśnienia. Wydaje się, że alarm nadal ma problemy, w przypadku awarii aktywuj dwa elementy sterujące nadpisaniem."
; EN: AltMessage="Lift activated. All personnel are reminded to complete assigned tasks."
AltMessage="Winda aktywowana. Wszystkim pracownikom przypomina się o wykonaniu przydzielonych zadań."
...
Message="Stan drenażu: Przepływ bioodpadów jest na nominalnym poziomie. Wszystkie pompy działają. Sekcja C jest pusta i dostępna dla każdego przelewu Biowaster. Upewnij się, że prowadzona jest regularna konserwacja rur."
...
Message="Status bezpieczeństwa: przy wejściu wykryto intruza. Aktywacja ekranów bezpieczeństwa w Laboratorium Badań Naukowych i Sekcji Hydroponiki. Wszystkie elementy bezpieczeństwa rozmieszczone są wokół punktów dostępu w sekcjach A, B i C, aby uniemożliwić intruzowi dostęp do windy 1."
; EN: Hint="Find the Containment rooms A, B and C and activate the buttons to access the Lift 1."
Hint="Znajdź pomieszczenia przechowawcze A, B i C i aktywuj przyciski dostępu do windy 1."
