...
ngWorldStatsHelp="Jeśli ta opcja jest zaznaczona, serwer będzie rejestrować i przechowywać dziennik statystyk rozgrywki."
...
SuggestPlayerSetupText="Twoje imię jest obecnie ustawione na „Gracz”. Zaleca się przejście do ustawień gracza i nadanie sobie innej nazwy przed rozpoczęciem gry wieloosobowej. \ N \ nCzy chcesz zamiast tego przejść do ustawień gracza?"
...
SuggestNetspeedText="Nie skonfigurowałeś jeszcze typu połączenia internetowego, z którym będziesz grać. Zaleca się przejście do ekranu Ustawienia sieci, aby zapewnić najlepszą jakość gier online. \ N \ nCzy chcesz zamiast tego przejść do Ustawień sieci?"
...
StyleHelp="Wybierz swój styl gry. Hardcore jest o 10% szybszy przy 50% wzroście obrażeń. Turbo dodaje również ultraszybki ruch gracza."
...
WeaponPriorityHelp="Kliknij i przeciągnij nazwę broni na liście po lewej stronie, aby zmienić jej priorytet. Broń znajdująca się wyżej na liście ma wyższy priorytet."
...
KeepHelp="Jeśli ta opcja jest zaznaczona, te mutatory będą zawsze używane podczas rozpoczynania gry."
...
DemoHelp="Nagranie demonstracyjne, nagraj grę, którą możesz obejrzeć później."
...
DriverHelp="To jest aktualny sterownik wideo. Naciśnij przycisk Uruchom ponownie, aby to zmienić."
...
SkinDetailHelp="Zmień szczegóły skórki gracza. Użyj niższych szczegółów karnacji, aby poprawić wydajność gry."
...
ScaleHelp="Dostosuj rozmiar elementów w interfejsie użytkownika."
; EN: ScaleSizes[0]="Normal"
ScaleSizes[0]="Normalna"
; EN: ScaleSizes[1]="Double"
ScaleSizes[1]="Podwójnie"
...
TranslatorScaleHelp="Dostosuj rozmiar translatora."
...
ConfirmDriverText="Czy chcesz ponownie uruchomić Unreal z wybranym sterownikiem wideo?"
; EN: PawnShadowText="Pawn shadows"
PawnShadowText="Cienie pionków"
; EN: PawnShadowHelp="Detail of shadows that pawns should cast on ground (the changes will take effect after a map change)."
PawnShadowHelp="Szczegóły cieni, które pionki powinny rzucać na ziemię (zmiany zaczną obowiązywać po zmianie mapy)."
; EN: PawnShadowList[0]="None"
PawnShadowList[0]="Żaden"
; EN: PawnShadowList[1]="Blob"
PawnShadowList[1]="Kropelka"
; EN: PawnShadowList[2]="Real-Time Low"
PawnShadowList[2]="Niski w czasie rzeczywistym"
; EN: PawnShadowList[3]="Real-Time Medium"
PawnShadowList[3]="Medium czasu rzeczywistego"
; EN: PawnShadowList[4]="Real-Time High"
PawnShadowList[4]="Wysoka w czasie rzeczywistym"
; EN: PawnShadowList[5]="Real-Time Ultra"
PawnShadowList[5]="Ultra w czasie rzeczywistym"
...
MinFramerateHelp="Jeśli liczba klatek na sekundę spadnie poniżej tej wartości, Unreal zredukuje efekty specjalne, aby zwiększyć liczbę klatek na sekundę."
...
DynamicLightsHelp="Jeśli ta opcja jest zaznaczona, w grze będzie używane dynamiczne oświetlenie."
...
DecoShadowsText="Dekoracyjne cienie"
; EN: DecoShadowsHelp="Whether decorations should cast shadows to the ground."
DecoShadowsHelp="Czy dekoracje powinny rzucać cień na ziemię."
; EN: FlatShadingText="Mesh flat shading"
FlatShadingText="Siatkowe cieniowanie płaskie"
; EN: FlatShadingHelp="Allow specific meshes render with flat shading lighting."
FlatShadingHelp="Zezwalaj na renderowanie określonych siatek z płaskim cieniującym oświetleniem."
; EN: CurvyMeshText="Curvy meshes"
CurvyMeshText="Siatki zakrzywione"
; EN: CurvyMeshHelp="Allow specific meshes render with some curved surfaces."
CurvyMeshHelp="Pozwól, aby określone siatki były renderowane z niektórymi zakrzywionymi powierzchniami."
...
VSyncText="Synchronizacja pionowa."
...
MapHelp="Wybierz mapę, na której chcesz zagrać."
...
LocalizedKeyName[137]="Nieznane 89"
...
LocalizedKeyName[144]="Num. Zamek"
...
JoyXHelp="Wybierz zachowanie lewej-prawej osi joysticka."
...
WeaponsHelp="Jeśli zaznaczone, broń pozostanie w miejscu odbioru po podniesieniu, zamiast odrodzić się."
...
BotSkillText="Umiejętność bota:"
; EN: BotSkillHelp="Adjust the bot difficulty (easy-hard)."
BotSkillHelp="Dostosuj poziom trudności bota (łatwy - trudny)."
; EN: BotAccurText="Accuracy:"
BotAccurText="Precyzja:"
; EN: BotAccurHelp="Adjust the bot aiming skill (bad aiming-good aiming)."
BotAccurHelp="Dostosuj umiejętność celowania bota (złe celowanie - dobre celowanie)."
...
BotCombatStyleHelp="Dostosuj styl walki botów (trzymaj się daleko, atakując - agresywnie zbliżaj się do wroga)."
...
BotAlertnessHelp="Czujność bota (nieświadomy swojego otoczenia - w pełni świadomy swojego otoczenia)."
; EN: BotCampingText="Camping:"
BotCampingText="Kemping:"
; EN: BotCampingHelp="Adjust how likely it is for the bot stay around camping (hunt at all time-camp a lot)."
BotCampingHelp="Dostosuj prawdopodobieństwo, że bot będzie przebywał w pobliżu kempingu (często poluj na obozach czasowych)."
...
FavoriteWeaponHelp="Ulubiona broń tego bota."
; EN: NoFavoriteWeapon="None prefered"
NoFavoriteWeapon="Nikt nie chciał"
...
LocalText="Rejestrowanie lokalne ngStats"
; EN: LocalHelp="If checked, your system will log local botmatch and single player tournament games for stat compilation."
LocalHelp="Jeśli zaznaczone, twój system będzie rejestrował lokalne gry typu botmatch i turnieje dla jednego gracza w celu kompilacji statystyk."
...
RTNPHeadingText="Wróć do Na Pali:"
; EN: RTNPHeadingHelp="Next settings are only for the mission pack: Return to Na Pali"
RTNPHeadingHelp="Następne ustawienia dotyczą tylko pakietu misji: Wróć do Na Pali"
; EN: CinematicText="Cinematic styled cutscenes"
CinematicText="Przerywniki filmowe w stylu filmowym"
; EN: CinematicHelp="Shows/Hides the cinematic widescreen style in cutscenes"
CinematicHelp="Pokazuje / ukrywa kinowy styl panoramiczny w przerywnikach filmowych"
; EN: SubtitlesText="Show subtitles"
SubtitlesText="Pokaż napisy"
; EN: SubtitlesHelp="Shows/Hides the subtitles text in cutscenes"
SubtitlesHelp="Pokazuje / ukrywa tekst napisów w przerywnikach filmowych"
...
SlotHelp="Naciśnij, aby zapisać bieżącą grę na tym slocie:"
...
AboutHelp="Zobacz napisy o tym, kto stworzył tę grę."
...
SlotHelp="Naciśnij, aby załadować grę z tego automatu:"
...
ProgrammersText="Programowanie"
; EN: LevelDesignText="Level design"
LevelDesignText="Projekt poziomu"
; EN: ArtText="Art and graphical design"
ArtText="Projekt artystyczny i graficzny"
; EN: MusicSoundText="Sound and music"
MusicSoundText="Dźwięk i muzyka"
BizText="Biz"
