...
UBrowserAS=Assaut
UBrowserLMS=Dernier homme en vie
UBrowserAll=Tous les serveurs

[UBrowserServerListWindow]
PlayerCountName=Joueurs
ServerCountName=Serveurs
QueryServerText=Requête sur serveur maître
QueryFailedText=Echec du serveur maître : 
PingingText=Test Ping sur serveurs
...
ChangeLevelsText=Changer de niveaux
MultiplayerBotsText=Bots en multijoueur
FragLimitText=Nombre de frags
...
MaxTeamsText=Nombre maximum d'équipes
FriendlyFireText=Tir ami :
MinPlayersText="Nombre minimum de bots"
PlayersText="Joueurs"
BalanceTeamsText="Equilibrer les équipes"
BotSkillText="Niveau d'habileté de bots"
MinNetVersionText=Version Compatible Min.
...
[UBrowserOpenCW]
OpenText=Ouvrir :
OpenHelp=Entrez un URL standard ou sélectionnez-en un dans l'historique. Appuyez sur Entrée pour activer la connexion.
...
WarningText=La fonction Chat vous connecte au réseau Internet Relay Chat (IRC).\n\nLegend Entertainment décline toute responsabilité quant au contenu des channels de l'IRC auquel vous vous connectez. Vous accédez à ces channels à vos propres risques.\n\nEtes-vous sûr de vouloir vous connecter ?
WarningTitle=Avertissement

[UBrowserRightClickMenu]
PlayName=&Jouer sur ce serveur
RefreshName=&Rafraîchir tous les serveurs
InfoName=Infos sur le &serveur et les joueurs
FavoritesName=Ajouter aux &favoris
RefreshServerName=Test P&ing sur ce serveur
PingAllName=Test &Ping sur tous les serveurs
...
[UBrowserInfoMenu]
RefreshName=&Rafraîchir les infos
CloseName=&Fermer
...
[UBrowserGSpyLink]
ResolveFailedError=Echec de résolution du serveur maître : 
TimeOutError=Dépassement de délai de communication avec le serveur maître.
CouldNotConnectError=Dépassement de délai dans la connexion avec le serveur maître : 
