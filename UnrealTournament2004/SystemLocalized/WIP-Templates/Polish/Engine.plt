...
Preferences=(Caption="Zaawansowany",Parent="Zaawansowane opcje")
...
Preferences=(Caption="Sieć",Parent="Zaawansowane opcje")
...
Preferences=(Caption="Ustawienia silnika gry",Parent="Zaawansowany",Class=Engine.GameEngine,Category=Settings,Immediate=True)
; EN: Preferences=(Caption="Key Aliases",Parent="Advanced",Class=Engine.Input,Immediate=True,Category=Aliases)
Preferences=(Caption="Kluczowe aliasy",Parent="Zaawansowany",Class=Engine.Input,Immediate=True,Category=Aliases)
; EN: Preferences=(Caption="Raw Key Bindings",Parent="Advanced",Class=Engine.Input,Immediate=True,Category=RawKeys)
Preferences=(Caption="Wiązania klawiszy surowych",Parent="Zaawansowany",Class=Engine.Input,Immediate=True,Category=RawKeys)
...
Preferences=(Caption="Informacje o serwerze publicznym",Parent="Sieć",Class=Engine.GameReplicationInfo,Immediate=True)
