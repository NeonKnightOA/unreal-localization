...
Preferences=(Caption="Gra w sieci TCP/IP",Parent="Sieć",Class=IpDrv.TcpNetDriver)
; EN: Preferences=(Caption="Server Beacon",Parent="Networking",Class=IpDrv.UdpBeacon,Immediate=True)
Preferences=(Caption="Sygnał nawigacyjny serwera",Parent="Sieć",Class=IpDrv.UdpBeacon,Immediate=True)
