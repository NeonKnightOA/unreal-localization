...
Object="(Nazwa=Core.HelloWorldCommandlet,Class=Class,MetaClass=Core.Commandlet)"
; EN: Preferences="(Caption="File System",Parent="Advanced",Class=Core.System,Immediate=True)"
Preferences="(Podpis="System plików",Parent="Zaawansowane",Class=Core.System,Immediate=True)"
